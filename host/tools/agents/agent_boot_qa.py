#!/usr/bin/env python3
"""
Agent 3: Boot QA — builds and runs host/tests/host/ Unity test suite.
"""
...
TESTS_DIR = ROOT / "host" / "tests" / "host"
...
def main():
    ...
    print(f"[boot-qa-agent] {summary['total']} tests, {summary['failures']} failures",
          file=sys.stderr)
    result = {
        "agent": "boot_qa",
